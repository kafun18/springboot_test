  ...
  <div>
    <div>
      <div style="display: flex;justify-content: space-between">
        <div>
          <!--@clear清空按钮时触发-->
          <el-input size="mini" placeholder="请输入员工名进行搜索，可以直接回车搜索..."
                    prefix-icon="el-icon-search" style="width:400px;margin-right: 10px"
                    v-model="keyword" clearable @clear="initEmp" @keydown.enter.native="initEmp"
                    :disabled="showAdvanceSearchView"></el-input>
          <el-button size="mini" icon="el-icon-search" type="primary" @click="initEmp" :disabled="showAdvanceSearchView">搜索</el-button>
          <el-button size="mini" type="primary" @click="showAdvanceSearchView = !showAdvanceSearchView">
            <i :class="showAdvanceSearchView?'fa fa-angle-double-down':'fa fa-angle-double-up'" aria-hidden="true"></i>
            高级搜索
          </el-button>
        </div>
        <div>
          ...
          <el-button size="mini" type="primary" icon="el-icon-plus" @click="showAddEmpView">
            添加用户
          </el-button>
        </div>
      </div>
      ...
      <div v-show="showAdvanceSearchView" style="border:1px solid #58b6ff;border-radius: 5px;box-sizing: border-box;padding: 5px;margin: 10px 0px;">
        <el-row>
          <el-col :span="5">
            政治面貌:
        ...
        <el-row style="margin-top: 10px;">
          <el-col :span="5">
            ...
            <el-popover
              ...
              trigger="manual"
              v-model="popVisible">
              <!--default-expand-all默认展开所有树节点-->
              <el-tree default-expand-all :data="allDeps" :props="defaultProps"
                       @node-click="searchViewhandleNodeClick"></el-tree>
              <!--cursor: pointer光标变成一个手指-->
              <!--align-items: center垂直居中-->
              <div slot="reference" style="width:150px;display: inline-flex;font-size: 13px;padding-left: 15px;
                border: 1px solid #dedede; height: 26px;border-radius: 5px;cursor: pointer;align-items: center;
          ...
          <el-col :span="5">
            ...
            <el-button size="mini" icon="el-icon-search" type="primary" @click="initEmp()">搜索</el-button>
          </el-col>
        </el-row>
      </div>
      </transition>
    ...
    <div style="margin-top: 10px">
      <el-table
        ...
        <el-table-column
          ...
          width="195">
          <template slot-scope="scope">
            <el-button style="padding: 3px;" size="mini" @click="showEditEmpView(scope.$index, scope.row)">编辑
            </el-button>
            <el-button style="padding: 3px;" size="mini" type="primary">查看高级资料</el-button>
            <el-button style="padding: 3px;" size="mini" type="danger"
                       @click="deleteEmp(scope.$index, scope.row)">删除
            </el-button>
          </template>
        </el-table-column>
      </el-table>
      <div class="block" style="display: flex;justify-content: flex-end">
        <!--@current-change点击每个页数触发的方法，@size-change改变一页的条数，
        layout是分页的各个按钮-->
        <el-pagination
          ...
          <el-row>
            ...
            <el-col :span="5">
              <el-form-item label="职称:" prop="jobLevelId">
                <el-select v-model="emp.jobLevelId" style="width: 120px" size="mini" placeholder="职称">
                  <el-option
            ...
            <el-col :span="6">
              <el-form-item label="所属部门:" prop="departmentId">
                <el-popover
                  ...
                  <!--align-items: center垂直居中-->
                  <div slot="reference" style="width:150px;display: inline-flex;font-size: 13px;padding-left: 15px;
                border: 1px solid #dedede; height: 26px;border-radius: 5px;cursor: pointer;align-items: center;box-sizing: border-box;"
                       @click="showDepView">{{inputDepName}}
                  </div>
                </el-popover>
              </el-form-item>
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="工号:" prop="workId">
                <el-input size="mini" style="width: 150px;" :disabled="true"
                          v-model="emp.workId" placeholder="工号"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item label="学历:" prop="tiptopDegree">
                <el-select v-model="emp.tiptopDegree" style="width: 120px" size="mini" placeholder="学历">
                  <el-option
            ...
            <el-col :span="8">
              <el-form-item label="聘用形式:" prop="engageForm">
                <el-radio-group v-model="emp.engageForm">
                  <el-radio label="劳动合同">劳动合同</el-radio>
                  <el-radio style="margin-left: 5px" label="劳务合同">劳务合同</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="婚姻状况:" prop="wedlock">
                <el-radio-group v-model="emp.wedlock">
                  ...
                  <el-radio style="margin-left: 5px" label="未婚">未婚</el-radio>
                  <el-radio style="margin-left: 5px" label="离异">离异</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-col>
          </el-row>
...
<script>
  export default {
    ...
    methods: {
      ...
      initEmp() {
        this.loading = true;
        /*let url = '/employee/basic/?page=' + this.page + "&size=" + this.size + "&name=" + this.keyword
        + '&politicId=' + this.searchValue.politicId + '&nationId=' + this.searchValue.nationId
