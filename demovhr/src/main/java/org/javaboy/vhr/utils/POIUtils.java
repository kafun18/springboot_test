...
//            row.createCell(19).setCellValue(emp.getBeginDate());
            HSSFCell cel19 = row.createCell(19);
            cel19.setCellStyle(dateCellStyle);
            cel19.setCellValue(emp.getBeginDate());
...
//            row.createCell(24).setCellValue(emp.getEndContract());
     ...
     * @return
     */
    public static List<Employee> excel2Employee(
            MultipartFile file, List<Nation> allNations,
